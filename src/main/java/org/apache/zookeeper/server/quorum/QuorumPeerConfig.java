...
public class QuorumPeerConfig {
    ...
    throws IOException, ConfigException {
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            } else if (key.startsWith("server.")) {//server.2=172.16.71.230:2888:11221
                int dot = key.indexOf('.');
                long sid = Long.parseLong(key.substring(dot + 1));//2
                String parts[] = value.split(":");//[172.16.71.230:2888:11221]
