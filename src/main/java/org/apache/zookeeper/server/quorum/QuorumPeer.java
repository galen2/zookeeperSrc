...
public class QuorumPeer extends Thread implements QuorumStats.Provider {
    ...
    public static class QuorumServer {
        ...
        public InetSocketAddress addr;//172.16.71.230:2888

        public InetSocketAddress electionAddr;///172.16.71.230:11221
        
        public long id;//配置文件sever.x的x值
    ...
    public synchronized void start() {
        loadDataBase();
        //2181端口监听打开，接受客户端请求。默认是NIOServerCnxnFactory
        cnxnFactory.start();        
        startLeaderElection();
        super.start();
    }
