    ...
    public void testDisconnectedAddAuth() throws Exception {
        ...
        try {
            ...
            try {
            	...
            	zk.create("/acl", "test".getBytes(),Ids.CREATOR_ALL_ACL,  CreateMode.PERSISTENT);
                zk.addAuthInfo("digest", "zhangsan:test".getBytes());
    ...
    public void testAcl() throws Exception{
        ...
        try {
            ...
            try {
            	...
            	zk.create("/acl", "test".getBytes(),list,  CreateMode.PERSISTENT);
            } finally {
                zk.close();
            }
        } finally {
